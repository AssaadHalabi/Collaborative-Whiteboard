...
export function Pricing() {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      if (!stripe)
        throw new Error(`Stripe is not available, its status is null`);
  ...
  return (
    <>
      <NavbarOuter />
      <div className='mx-auto w-full max-w-6xl px-4 py-12 md:px-6 md:py-20 lg:py-24'>
        <div className='grid gap-8 md:gap-12 lg:gap-16'>
          ...
          <div className='lg:g2 grid md:grid-cols-2'>
            <Card>
              <CardHeader>
            ...
            <Card>
              ...
              <CardFooter className='flex flex-row items-center justify-between'>
                ...
                {isPremium ? (
                  <Button variant='black' className='ml-2 w-full' disabled>
                    Current Plan
                  </Button>
                ) : (
                  <Button
